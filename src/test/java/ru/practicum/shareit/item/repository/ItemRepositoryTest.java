...
class ItemRepositoryTest {
    ...
    void searchAvailableItems() {
        ...
        List<Item> itemsRes1 = itemRepository.searchAvailableItems("item2", Pageable.unpaged());
        List<Item> itemList1 = itemsRes1;
        ...
        List<Item> itemsRes2 = itemRepository.searchAvailableItems("description",Pageable.unpaged());
        List<Item> itemList2 = itemsRes2;
