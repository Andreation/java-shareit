...
class BookingServiceImplTest {
    ...
    void getBookingBookerTest() {
        ...
        when(bookingRepository.findAllByBookerIdAndStartAfterOrderByStartDesc(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of());
        when(bookingRepository.findAllByBookerIdAndStartBeforeAndEndAfter(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of());
    ...
    void getBookingOwnerTest() {
        ...
        when(bookingRepository.findAllByOwnerIdAndStartAfter(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of());
        when(bookingRepository.findAllByOwnerIdAndStartBeforeAndEndAfter(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of());
